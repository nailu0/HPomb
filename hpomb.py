...
We will change our Tool Name [HBomb To HPomb ] \n ( SO now you need to python hpomb.py for run this tool )
...
def active():
    try:
        ...
        print(r.status_code)
        print("\tPlease Restart HPomb Tool")
...
ver = urllib.request.urlopen(
    "https://raw.githubusercontent.com/HoneyPots0/HPomb/master/.version").read().decode('utf-8')
verl = ''
try:
    verl = open(".version", 'r').read()
except Exception:
